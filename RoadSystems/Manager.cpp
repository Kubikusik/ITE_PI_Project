...
void Manager::CreateButtons(std::vector<Paint_Button>& color_button_list, std::vector<sf::Color>& color_list){
    ...
    // Sand Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/sand.png")) std::cout << "ERROR OF TEXTURE";
    ...
    // Plant Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/plant.png")) std::cout << "ERROR OF TEXTURE";
    else std::cout << "CORRECTO MUNDO";
    ...
    // Water Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/water.png")) std::cout << "ERROR OF TEXTURE";
    else std::cout << "CORRECTO MUNDO";
    ...
    // Fire Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/fire.png")) std::cout << "ERROR OF TEXTURE";
    ...
    // Steel Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/steel.png")) std::cout << "ERROR OF TEXTURE";
    ...
    // Conway Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/nanomashine.png")) std::cout << "ERROR OF TEXTURE";
    ...
    // Cable Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/kabel.png")) std::cout << "ERROR OF TEXTURE";
    ...
    // Save Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/save.png")) std::cout << "ERROR OF TEXTURE";
    ...
    // Load Button
    if (!temp_texture.loadFromFile("./Textures/UIButtons/SubstanceButtons/load.png")) std::cout << "ERROR OF TEXTURE";
